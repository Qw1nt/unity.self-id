...
namespace Qw1nt.Editor.SelfIds
{
    ...
    {
        private const float EmpiricCalculatedHeight = 105f;
        ...
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            var usePrefixRect = CalculateRect(position, idLabelRect, usePrefix, 35f);
        ...
        private void DrawIdPart(Rect position, SerializedProperty id)
        {
